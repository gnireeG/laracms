<dialog id="component-modal-{{ $this->getId() }}" class="modal top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4">
    ...
    <h3 class="font-bold text-lg mb-4">Edit Component {{ $this->getId() }}</h3>
